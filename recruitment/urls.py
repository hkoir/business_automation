...
urlpatterns = [
    ...
    path('search_applications/', views.search_applications, name='search_applications'),
     ...
     path('delete_panel_member/', views.delete_panel_member, name='delete_panel_member'),
     
     path('panel_details/<int:id>/', views.panel_details, name='panel_details'),  
    path('job/<int:job_id>/exam/<int:exam_id>/candidate/<int:candidate_id>/panel_member/<int:panel_member_id>/score/', 
         views.panel_member_scoring, name='panel_member_scoring'),
