...
class ExistingOrderForm(forms.ModelForm):
    class Meta:
        model = ExistingOrder  
        fields = ['category', 'product', 'quantity', 'warehouse', 'location']  
...
class OperationsDeliveryForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['product','quantity','operations_request_order', 'operations_request_item','warehouse','location']  
