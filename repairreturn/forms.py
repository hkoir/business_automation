...
class ReplacementProductForm(forms.ModelForm):
    class Meta:
        model = Replacement
        fields = ['source_inventory','warehouse','location','quantity','status']  
...
class ScrapProductForm(forms.ModelForm):
    ...
    class Meta:
        model = ScrappedItem
        fields = ['scrapped_product','source_inventory','quantity','feedback']  
...
class ScrapConfirmationForm(forms.ModelForm):
    class Meta:
        model = ScrappedItem 
        fields = ['scrapped_order', 'scrapped_product', 'warehouse', 'location', 'quantity']
